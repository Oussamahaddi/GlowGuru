...
<section class="flex justify-center mt-10 relative">
	<img src="<?= URLROOT; ?>/img/logo/skins.png" alt="" class="absolute -top-4 left-1/2 -translate-x-1/2 -z-10 w-4/6 max-sm:5/6 max-sm:top-1/2">
	<div class="grid grid-cols-1 sm:grid-cols-2 items-center justify-center w-5/6">
		<div>
			<img src="<?= URLROOT; ?>/img/slider/sliderbg.png" alt="">
		</div>
		<div class="skin flex flex-col gap-6 text-center sm:text-end relative">
			<h1 class="Thunder text-8xl text-[#E1726E] max-sm:text-6xl">GlowGuru</h1>
			...
			<a href="#" class="relative font-semibold flex items-center justify-center text-gray-700 hover:text-black hover:drop-shadow-[4px_4px_1px_rgb(255,150,0,0.50)] hover:transition-all hover:duration-300">
				<img src="<?= URLROOT; ?>/img/logo/libg.png" alt="" class="w-52 h-12 absolute mt-2 ml-4 -z-10">
				Check Out More
			</a>
		</div>
	</div>
...
<!-- about start -->
<section class="relative my-24 py-8 gradient w-full h-full flex items-center justify-center mx-auto after:content-[''] after:absolute after:bg-gray-100 after:w-full after:h-full after:top-0 after:left-0 after:-z-20 after:-skew-y-2 before:content-[''] before:absolute before:w-11/12 before:h-full before:-bottom-4 before:right-0 before:-z-20 before:-skew-y-2">
	<div class="grid grid-cols-1 w-5/6 m-auto md:grid-cols-2 max-sm:gap-8">
		<div class="flex flex-col justify-around relative z-30 max-sm:gap-6">
			...
			<a href="#" class="relative font-semibold flex items-center justify-center text-gray-700 hover:text-black hover:drop-shadow-[4px_4px_1px_rgb(255,150,0,0.50)] hover:transition-all hover:duration-300">
				AMAZING
				<img src="<?= URLROOT; ?>/img/logo/libg.png" alt="" class="w-40 h-12 absolute mt-2 ml-4 -z-10">
			</a>
		</div>
		<div class="w-full">
			<div class="w-fit h-fit relative gradient flex justify-center items-center p-8 before:content-[''] before:absolute before:top-5 before:right-14 before:w-4/6 before:h-4/6 before:-z-10 max-sm:before:right-10">
				<img src="<?= URLROOT; ?>/img/product/pc/beauty.jpg" alt="" class="relative w-5/6 border-4 border-black z-30">
			</div>
		</div>
	</div>
</section>
