...
<body class="h-screen w-full bg-no-repeat bg-cover" style="background-image: url(<?= URLROOT . '/img/bg.png';?>); background-color: #ECE0DB;">
    ...
    <div class=" h-screen w-full grid place-items-center -mt-">
        <div class="block p-6 rounded-lg shadow-lg bg-white/50">
            <form action="<?= URLROOT . '/Dashboards/addProduct'; ?>" id="form" method="POST" enctype="multipart/form-data">
                <div id="formInp">
                    <div class="form-group mb-6">
                        ...
                        <span class="text-red-400 my-2"><?= $data['product_name_err']; ?></span>
                    </div>
                    <div class="form-group mb-6 flex gap-4">
                        <div class="">
                            ...
                            <span class="text-red-400 my-2"><?= $data['product_price_err']; ?></span>
                        </div>
                        <div class="">
                            ...
                            <span class="text-red-400 my-2"><?= $data['product_quantity_err']; ?></span>
                        </div>
                    </div>
                    <div class="form-group mb-6">
                        <textarea name="description[]" class=" form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none "  rows="3" placeholder="Product Description" >
                            <?= $data['product_description']; ?>
                        </textarea>
                        <span class="text-red-400 my-2"><?= $data['product_description_err']; ?></span>
                    </div>
                    <div class="form-group mb-6 w-full">
                        <input type="file" name="image[]" class="block">
                        <span class="text-red-400 my-2"><?= $data['product_image_err']; ?></span>
                    </div>
                ...
                <div class="flex gap-2">
                    ...
                    <button id="add_more" class=" w-full px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out font-semibold">ADD MORE</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script src="<?= URLROOT . '/js/addMoreItems.js'; ?>"></script>
</html>